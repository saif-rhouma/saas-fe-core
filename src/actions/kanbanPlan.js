...
export function useGetPlanBoard() {
  const { data, isLoading, error, isValidating } = useSWR(
    KANBAN_PLAN_ENDPOINT,
    fetcher,
    swrOptions
  );
...
export async function createColumn(columnData) {
  ...
  if (enableServer) {
    ...
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'create-column' } });
  }
...
export async function updateColumn(columnId, columnName) {
  ...
  if (enableServer) {
    ...
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'update-column' } });
  }
...
export async function moveColumn(updateColumns) {
  ...
  if (enableServer) {
    ...
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'move-column' } });
  }
}
...
export async function clearColumn(columnId) {
  ...
  if (enableServer) {
    const data = { columnId };
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'clear-column' } });
  }
...
export async function deleteColumn(columnId) {
  ...
  if (enableServer) {
    const data = { columnId };
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'delete-column' } });
  }
...
export async function createTask(columnId, taskData) {
  ...
  if (enableServer) {
    ...
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'create-task' } });
  }
...
export async function updateTask(columnId, taskData) {
  ...
  if (enableServer) {
    const data = { columnId, taskData };
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'update-task' } });
  }
...
export async function moveTask(updateTasks) {
  ...
  //   await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'move-task' } });
  // }
}
...
export async function deleteTask(columnId, taskId) {
  ...
  if (enableServer) {
    ...
    await axios.post(KANBAN_PLAN_ENDPOINT, data, { params: { endpoint: 'delete-task' } });
  }
