...
//   staffPhone: zod.number().min(1, { message: 'Phone Number is required!' }),
...
//       setValue('taxes', 0);
//     } else {
//       setValue('taxes', currentStaff?.taxes || 0);
//     }
//   }, [currentStaff?.taxes, includeTaxes, setValue]);
...
//           >
//             <TextField label="Staff Name" onChange={handleOrderId} />
//             <TextField label="Phone Number" onChange={handleOrderId} />
//           </Box>
...
//             gridTemplateColumns={{ xs: 'repeat(1, 1fr)', md: 'repeat(2, 1fr)' }}
//           >
//             <TextField label="Email" onChange={handleOrderId} />
//             <TextField label="Password" onChange={handleOrderId} />
//           </Box>
